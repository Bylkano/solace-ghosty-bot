...
TRIVIA_BANK: dict[str, list[str]] = {
    ...
    "What is the largest desert in the world?": ["antarctica", "antarctic", "sahara"],
    "How many minutes are in a full day?": ["1440"],
    "Who wrote the Harry Potter book series?": ["rowling", "j.k. rowling", "jk rowling"],
    ...
    "Who was the first man to walk on the Moon?": ["armstrong", "neil armstrong"],
    "What is the largest country by area?": ["russia"],
    "What musical instrument has 88 keys?": ["piano"],
    "Which vitamin is produced when skin is exposed to sunlight?": ["vitamin d", "d"],
    ...
    "What is often called the powerhouse of the cell?": ["mitochondria", "mitochondrion"],
    ...
    "What is the scientific study of living organisms called?": ["biology"],
    ...
    "Who is often called the Father of the Computer?": ["babbage", "charles babbage"],
    "Which gas is most abundant in Earth's atmosphere?": ["nitrogen"],
    "What is the largest big cat in the world?": ["tiger"],
    "Who wrote the tragedy 'Hamlet'?": ["shakespeare", "william shakespeare"],
    "Which bird is commonly a symbol of peace?": ["dove"],
    "What is the process by which plants make their food?": ["photosynthesis"],
    "Which planet rotates on its side?": ["uranus"],
    "Who is credited with inventing the telephone?": ["bell", "alexander graham bell"],
    "How many continents start with the letter A?": ["3", "three"],
    ...
    "What is the hardest known mineral on the Mohs scale?": ["diamond"],
    ...
    "Which blood type is the universal donor?": ["o negative", "o-", "o"],
    "What is the longest bone in the human body?": ["femur"],
    "What is the smallest bone in the human body?": ["stapes"],
    "How many chambers does the human heart have?": ["4", "four"],
    "What part of the plant conducts photosynthesis?": ["leaf", "leaves"],
    "What is the basic unit of life?": ["cell"],
    "What force keeps planets in orbit around the Sun?": ["gravity"],
    "What is the speed of light approximately, in km per second?": ["300000", "299792", "299792458 m/s"],
    "Who proposed the three laws of motion?": ["newton", "isaac newton"],
    "What is H2O more commonly known as?": ["water"],
    "What is NaCl commonly known as?": ["salt", "table salt"],
    "What galaxy is Earth located in?": ["milky way"],
    "What is the name of our Sun's star system?": ["solar system"],
    "How long does light from the Sun take to reach Earth (minutes)?": ["8", "eight", "8 minutes"],
    "Which planet has the Great Red Spot?": ["jupiter"],
    "What is the name of the first artificial satellite?": ["sputnik", "sputnik 1"],
    "What year did humans first land on the Moon?": ["1969"],
    "What is the study of the stars and universe called?": ["astronomy"],
    "Who wrote the novel '1984'?": ["orwell", "george orwell"],
    "Who wrote 'Pride and Prejudice'?": ["austen", "jane austen"],
    "Who wrote 'The Great Gatsby'?": ["fitzgerald", "f. scott fitzgerald"],
    "Who wrote 'Don Quixote'?": ["cervantes", "miguel de cervantes"],
    "In which language was the original Bible's New Testament mostly written?": ["greek"],
    "What is the longest-running animated TV show?": ["the simpsons", "simpsons"],
    "What is the highest-grossing film franchise about a wizard boy?": ["harry potter"],
    "Which fictional detective lived at 221B Baker Street?": ["sherlock holmes", "sherlock"],
    ...
    "How many points is the letter Q worth in Scrabble?": ["10", "ten"],
    "In which sport would you perform a slam dunk?": ["basketball"],
    "How many rings are on the Olympic flag?": ["5", "five"],
    "What sport is associated with Wimbledon?": ["tennis"],
    "How often are the Summer Olympic Games held (years)?": ["4", "four"],
    "In soccer, how many points is a goal worth?": ["1", "one"],
    ...
    "What fruit is traditionally used to make wine?": ["grapes", "grape"],
    "From what bean is chocolate made?": ["cacao", "cocoa", "cacao bean"],
    "What is the most consumed beverage in the world after water?": ["tea"],
    "What type of pastry is used to make profiteroles?": ["choux", "choux pastry"],
    "Which country is famous for inventing pizza?": ["italy"],
    "What is dried plum called?": ["prune"],
    "What is the currency of the United Kingdom?": ["pound", "pound sterling", "gbp"],
    "What is the currency used across most of the European Union?": ["euro"],
    ...
    "Which country has the largest population?": ["india", "china"],
    "What is the longest wall in the world?": ["great wall of china", "great wall"],
    "On which continent is the Sahara Desert located?": ["africa"],
    "What is the deepest ocean trench called?": ["mariana trench", "marianas trench"],
    ...
    "How many elements are in the modern periodic table approximately?": ["118"],
    "What is the pH value of pure water?": ["7", "seven"],
    "Which acid is found in lemons?": ["citric acid", "citric"],
